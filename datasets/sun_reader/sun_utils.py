...
# Label map
sun_labels = ('bathtub', 'bed', 'bookshelf', 'box', 'chair', 'counter', 'desk', 'door', 'dresser', 'garbage_bin',
              'lamp', 'monitor', 'night_stand', 'pillow', 'sink', 'sofa', 'table', 'tv', 'toilet')
label_map = {k: v for v, k in enumerate(sun_labels)}
label_map['background'] = 19
